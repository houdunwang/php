...
import { watch, h, markRaw, shallowRef, resolveComponent } from 'vue'
import { useRoute } from 'vue-router'
import { RouteEnum } from '@@/enum/RouteEnum'
import RenderComponent from '@@/components/core/hd/renderComponent.vue'
      ...
      <div class="container">
        <dl v-for="(menu, index) of menuService.menus.value" :key="index">
          <dt @click="menuService.toggleParentMenu(menu)">
            <section>
              <!-- <CoreHdRenderComponent /> -->
              <component :is="menu.icon!" size="18" fill="#dcdcdc" class="mr-2" v-if="menu?.icon" />
